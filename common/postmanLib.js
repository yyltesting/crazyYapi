...
async function crossRequest(defaultOptions, preScript, afterScript,case_pre_script,case_post_script,colpre_script,colafter_script,ws, commonContext = {}) {
 ...
 // console.log({defaultOptions, preScript, afterScript,case_pre_script,case_post_script, commonContext})
  ...
  context.utils = await Object.freeze({
    ...
    incentiveStake:utils.incentiveStake,
    incentiveAdminStake:utils.incentiveAdminStake,
    incentiveWithdraw:utils.incentiveWithdraw,
    incentiveFundInterestPool:utils.incentiveFundInterestPool,
    incentiveSetMinimumStake:utils.incentiveSetMinimumStake,
    incentiveGetWithdrawalAddressStakeDetails:utils.incentiveGetWithdrawalAddressStakeDetails,
    incentiveAddToWhitelist:utils.incentiveAddToWhitelist,
