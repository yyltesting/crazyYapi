...
let routerConfig = {
  ...
  user: [
    ...
    {
      action: 'Vcodeuppassword',
      path: 'Vcodeuppassword',
      method: 'post'
    }
  ],
  project: [
    ...
    },
    {
      ...
      path:'redisconnection',
      method:'post'
    },
    {
      action:'mysqlconnection',
  ...
  interface: [
    ...
    {
      action:'importGolangApi',
      path:'importGolangApi',
      method:'post'
    },
    {
      action:'importGolangApifile',
      path:'importGolangApifile',
      method:'post'
    },
    {
      action: 'add',
  ...
  col: [
    ...
    {
      action: 'addCaseListBach',
      path: 'add_case_list_bach',
      method: 'post'
    },
    {
