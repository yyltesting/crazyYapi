...
import demandlib from './Setting/demandlib/demandlib.js';
...
import stats from './Setting/stats/stats.js';
...
export default class Project extends Component {
  ...
  render() {
    ...
    let routers = {
      ...
      demandlib: { name: '需求用例库', path: '/project/:id/demandlib', component: demandlib },
      stats:{ name: '统计', path: '/project/:id/stats', component: stats }
    };
